      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="flex items-center gap-3">
            ...
            >
              INFINITY{" "}
              <span style={{ color: "var(--c-text-sec)", fontWeight: 300 }}>
                TECH
              </span>
            </span>
          </div>
          ...
          >
            Laboratorio especializado en reingeniería de dispositivos móviles,
            venta de componentes originales y accesorios premium.
          </p>
          {/* Social Links */}
            ...
            >
              <li className="flex items-start gap-3">
                ...
                <span className="leading-relaxed">
                  Calle Comercio Gal. Elegans #850, Of. 2 y 3
                </span>
              </li>
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          ...
          <a
            href="https://maps.google.com/?q=-16.494595,-68.136316"
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full h-40 rounded-[24px] overflow-hidden border transition-all duration-300"
            style={{
          ...
          >
            <iframe
              ...
              src="https://maps.google.com/maps?q=-16.494595,-68.136316&z=15&output=embed"
